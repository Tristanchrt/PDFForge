...
export class RestPdfOptions {
  @ApiPropertyOptional({
    ...
    example: 'My PDF Report',
  })
  title?: string;

  @ApiPropertyOptional({
    description: 'Scale factor for the document',
    example: 1,
  })
  scale?: number;
  ...
  @ApiPropertyOptional({
    description: 'Prefer CSS-defined page size',
    example: true,
  })
  ...
  @ApiPropertyOptional({
    type: RestPdfMargin,
    description: 'Margins for the document',
  })
  ...
  @ApiPropertyOptional({
    description: 'Omit background graphics',
    example: false,
  })
  omitBackground?: boolean;

  @ApiPropertyOptional({
    description: 'Enable tagged PDF for accessibility',
    example: true,
  })
  tagged?: boolean;

  @ApiPropertyOptional({
    description: 'Include an outline in the PDF',
    example: false,
  })
  outline?: boolean;
